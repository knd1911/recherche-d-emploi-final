...
--
-- Hôte : localhost
-- Généré le : sam. 27 jan. 2024 à 16:46
...
(1, 'admin@gmail.com', '90b9aa7e25f80cf4f64e990b78a9fc5ebd6cecad');
...
(64, 'Mr', 'ODG', 'Achraf', 23456789, 'test2@gmail.com', 'profile.jpeg', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkinabé'),
(65, 'Mr', 'ODG', 'Achraf', 23456789, 'test3@gmail.com', 'profile.jpeg', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkinabé'),
(66, 'Mr', 'ODG', 'Achraf', 23456789, 'test4@gmail.com', 'profile.jpeg', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkinabé'),
(67, '', 'ODG', 'Achraf', 23456789, 'test5@gmail.com', 'profile.jpeg', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkinabé'),
(68, '', 'ODG', 'Achraf', 23456789, 'test6@gmail.com', 'profile.jpeg', '63982e54a7aeb0d89910475ba6dbd3ca6dd4e5a1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Burkinabé');

-- --------------------------------------------------------

--
-- Structure de la table `compteur_vue`
--

CREATE TABLE `compteur_vue` (
  `id` int NOT NULL,
  `date` date NOT NULL,
...
--
-- Déchargement des données de la table `compteur_vue`
--

INSERT INTO `compteur_vue` (`id`, `date`, `compteur`) VALUES
(1, '2024-01-27', 27),
(2, '2024-01-26', 267);
...
(1, 3, 'Aide macon', 'CDD', 2, 'pour aider dans la constrution d\'un immeuble', 'pas de competences requises', 'Ouagadougou', 'WhatsApp Image 2023-12-28 at 02.07.13.jpeg', 'BTP, construction', 'Qualification avant bac', '2024-01-10 16:53:35', '2024-01-10 16:53:35', 7),
...
(8, 2, 'fvhdfvuisdfsh', 'Intérim', 1111, 'wtruipo\\', 'wertyuiopgrgsr', 'Bobo Dioulasso', '3b6885e2-a81f-47ca-88dc-a618873ae43c.jpg', 'Activités associatives', 'Bac', '2024-01-21 12:50:33', '2024-01-21 12:50:33', 3);
...
--
-- Index pour la table `compteur_vue`
--
ALTER TABLE `compteur_vue`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `emploi`
  ...
  ADD KEY `emploi_ibfk_1` (`id_entreprise`);
...
ALTER TABLE `postuler`
  ...
  ADD KEY `postuler_ibfk_1` (`id_emploi`),
  ADD KEY `postuler_ibfk_2` (`id_candidat`),
  ADD KEY `postuler_ibfk_3` (`id_entreprise`);
...
--
ALTER TABLE `candidat`
  MODIFY `id_candidat` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT pour la table `compteur_vue`
--
ALTER TABLE `compteur_vue`
...
--
ALTER TABLE `emploi`
  MODIFY `id_emploi` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `postuler`
  MODIFY `id_postuler` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `emploi`
  ADD CONSTRAINT `emploi_ibfk_1` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id_entreprise`) ON DELETE CASCADE ON UPDATE RESTRICT;

--
-- Contraintes pour la table `postuler`
--
ALTER TABLE `postuler`
  ADD CONSTRAINT `postuler_ibfk_1` FOREIGN KEY (`id_emploi`) REFERENCES `emploi` (`id_emploi`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `postuler_ibfk_2` FOREIGN KEY (`id_candidat`) REFERENCES `candidat` (`id_candidat`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `postuler_ibfk_3` FOREIGN KEY (`id_entreprise`) REFERENCES `entreprise` (`id_entreprise`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
